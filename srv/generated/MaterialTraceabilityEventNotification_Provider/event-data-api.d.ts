 ...
 */
export declare const EventDataApi: {
    /**
     ...
     */
    create: (body: MaterialTraceabilityEventNotification) => OpenApiRequestBuilder<string>;
};
//# sourceMappingURL=event-data-api.d.ts.map